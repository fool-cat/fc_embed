...
extern "C"
{
    ...
    void  fc_pool_fifo_walk(void *ptr, fc_pool_walker_t walker, void *user);  // 遍历pop出来的链式非连续内存块

    void fc_pool_walk(fc_pool_t *pool, fc_pool_walker_t walker, void *user);  // 遍历整个fifo used队列链表
