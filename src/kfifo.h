...
#define kfifo_from_user(fifo, from, len, copied)                                                                                                     \
    __kfifo_uint_must_check_helper(                                                                                                                  \
        ({                                                                                                                                           \
            ...
            const size_t       __recsize = sizeof(*__tmp->rectype);                                                                                  \
            struct __kfifo*    __kfifo = &__tmp->kfifo;                                                                                              \
            (__recsize) ? __kfifo_from_user_r(__kfifo, __from, __len, __copied, __recsize) : __kfifo_from_user(__kfifo, __from, __len, __copied); \
        }))
...
#define kfifo_to_user(fifo, to, len, copied)                                                                                                 \
    __kfifo_uint_must_check_helper(                                                                                                          \
        ({                                                                                                                                   \
            ...
            const size_t       __recsize = sizeof(*__tmp->rectype);                                                                          \
            struct __kfifo*    __kfifo = &__tmp->kfifo;                                                                                      \
            (__recsize) ? __kfifo_to_user_r(__kfifo, __to, __len, __copied, __recsize) : __kfifo_to_user(__kfifo, __to, __len, __copied); \
        }))
...
#define kfifo_dma_in_prepare(fifo, sgl, nents, len)                                                                                                     \
    ({                                                                                                                                                  \
        ...
        const size_t        __recsize = sizeof(*__tmp->rectype);                                                                                        \
        struct __kfifo*     __kfifo = &__tmp->kfifo;                                                                                                    \
        (__recsize) ? __kfifo_dma_in_prepare_r(__kfifo, __sgl, __nents, __len, __recsize) : __kfifo_dma_in_prepare(__kfifo, __sgl, __nents, __len); \
    })
...
#define kfifo_dma_out_prepare(fifo, sgl, nents, len)                                                                                                      \
    ({                                                                                                                                                    \
        ...
        const size_t        __recsize = sizeof(*__tmp->rectype);                                                                                          \
        struct __kfifo*     __kfifo = &__tmp->kfifo;                                                                                                      \
        (__recsize) ? __kfifo_dma_out_prepare_r(__kfifo, __sgl, __nents, __len, __recsize) : __kfifo_dma_out_prepare(__kfifo, __sgl, __nents, __len); \
    })
